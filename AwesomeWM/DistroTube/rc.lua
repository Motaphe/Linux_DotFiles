...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " CODE ", " DOC ", " SYS ", " MUS ", " VID ", " WWW ", " VBOX ", " CHAT ", " MISC " }
...
globalkeys = my_table.join(
    ...
    -- Brightness
    awful.key({ ctrlkey }, "Up", function () os.execute("blight set +20%") end,
        {description = "increase brightness by +20%", group = "hotkeys"}),
    awful.key({ ctrlkey }, "Down", function () os.execute("blight set -20%") end,
        {description = "decrease brightness by -20%", group = "hotkeys"}),

    -- ALSA volume control
    --awful.key({ ctrlkey }, "Up",
    awful.key({ modkey }, "Up", function () os.execute("pactl set-sink-volume bluez_sink.CC_98_8B_1F_E8_A1.a2dp_sink +10% || pactl set-sink-volume alsa_output.pci-0000_01_00.1.hdmi-stereo +10% || pactl set-sink-volume alsa_output.pci-0000_00_1f.3.analog-stereo +10%") end,
        {description = "increase volume by +10%", group = "hotkeys"}),
    --awful.key({ ctrlkey }, "Down",
    awful.key({ modkey }, "Down", function () os.execute("pactl set-sink-volume bluez_sink.CC_98_8B_1F_E8_A1.a2dp_sink -10% || pactl set-sink-volume alsa_output.pci-0000_01_00.1.hdmi-stereo -10% || pactl set-sink-volume alsa_output.pci-0000_00_1f.3.analog-stereo -10%") end,
        {description = "decrease volume by -10%", group = "hotkeys"}),
    awful.key({ modkey }, "F1", function () os.execute("pactl set-sink-mute bluez_sink.CC_98_8B_1F_E8_A1.a2dp_sink toggle || pactl set-sink-mute alsa_output.pci-0000_01_00.1.hdmi-stereo toggle || pactl set-sink-mute alsa_output.pci-0000_00_1f.3.analog-stereo toggle") end,
        {description = "toggle mute", group = "hotkeys"}),
    
    -- Screenshot
    awful.key({ }, "Print", function () awful.util.spawn("spectacle") end,
        {description = "launches spectacle to snip window", group = "custom keybinds"}),

    -- Launches File Manager
    awful.key({ modkey }, "e", function () awful.util.spawn("thunar") end,
              {description = "launches thunar file manager", group = "custom keybinds"}),
    
    -- Launches Discord
    awful.key({ modkey },            "d",     function () awful.util.spawn("discord") end,
              {description = "launches discord", group = "custom keybinds"}),

    -- Launches VS Code
    awful.key({ modkey },            "c",     function () awful.util.spawn("code") end,
              {description = "launches virtualbox", group = "custom keybinds"}),

    -- Launches Firefox
    awful.key({ modkey },            "f",     function () awful.util.spawn("firefox") end,
              {description = "launches firefox", group = "custom keybinds"}),

    -- Lockscreen
    awful.key({ altkey },            "l",     function () awful.util.spawn("i3lock-fancy") end,
              {description = "lockscreen", group = "custom keybinds"}),
...
os.execute("xrandr --output HDMI-1-0 --mode 1920x1080 --rate 165 --primary --output eDP-1 --mode 1920x1080 --rate 60 --right-of HDMI-1-0")
